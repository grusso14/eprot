...
<table summary="">
	...
	<tr>
		...
		<td><html:text property="nominativoDestinatario"
			styleClass="obbligatorio" styleId="nominativoDestinatario" maxlength="160"></html:text> &nbsp; <label
	...
	<tr>
		...
		<html:text property="capDestinatario" styleId="capDestinatario" size="6" maxlength="5"></html:text></td>
	</tr>
	<tr>
...
<logic:notEmpty name="documentoForm" property="destinatari">
	<bean:define id="destinatari" name="documentoForm" property="destinatari" />
	<hr></hr>
	<table summary="" border="1" width="98%">
		...
		<logic:iterate id="currentRecord" name="documentoForm"
			...
			<tr>
				...
				<td><span> <html:link action="/page/documentale/inviaDocumento.do"
					paramId="destinatarioId" paramName="currentRecord"
					paramProperty="idx">
					<bean:write name="currentRecord" property="destinatario" />
				</html:link> </span></td>
				<td><span><bean:write name="currentRecord" property="indirizzo" /></span></br>
				<span><bean:write name="currentRecord" property="capDestinatario" /></span></br>
				<span><bean:write name="currentRecord" property="citta" /></span></td>
...
<p><logic:notEmpty name="documentoForm" property="destinatari">
