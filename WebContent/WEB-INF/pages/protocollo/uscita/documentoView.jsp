...
<div class="sezione">
<bean:define id="sezioneVisualizzata" name="protocolloUscitaForm" property="sezioneVisualizzata" />
<jsp:include page="/WEB-INF/subpages/protocollo/common/link-sezioni.jsp" />
	<logic:equal name="sezioneVisualizzata" value="Mittente">
		<jsp:include page="/WEB-INF/subpages/protocollo/uscita/mittenteView.jsp" />
	</logic:equal>
...
<logic:equal name="protocolloForm" property="versioneDefault" value="true">
	...
	<logic:notEqual name="protocolloForm" property="protocolloId" value="0">
		...
		<logic:equal name="protocolloForm" property="flagTipo" value="U">	
			<html:submit styleClass="submit" property="btnRipetiDatiU" value="Ripeti dati" alt="Genera nuovo protocollo in uscita dai dati correnti" />
		</logic:equal>
