...
<eprot:page title="Gestione documentale">
	<logic:equal parameter="documentoRegistrato" value="true"
		...
		<div id="protocollo_registrato">
			<bean:message key="documentale.salvatocorrettamente" />
			.
		</div>
		<br />
	</logic:equal>
		...
		<div id="protocollo">
			...
			<logic:notEmpty name="documentoForm" property="permessi">
				<div class="sezione">
					<span class="title"><strong><bean:message
								key="documentale.permessi" /></strong></span>
			...
			<div>
				...
				<logic:equal name="documentoForm" property="versioneDefault"
					value="true">
					<logic:notEqual name="documentoForm" property="documentoId"
						value="0">

						<logic:equal name="documentoForm" property="statoArchivio"
							value="L">
							<!-- in Lavorazione -->
							<logic:equal name="documentoForm" property="permessoCorrente"
								value="2">
								<logic:equal name="documentoForm" property="statoDocumento"
									value="1">
									<logic:equal name="documentoForm" property="owner" value="true">
										<html:submit styleClass="submit"
											property="modificaDocumentoAction" value="Modifica"
											alt="Modifica documento" />
										<html:submit styleClass="submit"
											property="visualizzaClassificaDocumentoAction"
											value="Classifica" alt="Classifica il documento" />
										<html:submit styleClass="submit"
											property="checkinDocumentoAction" value="Check-In"
											alt="Check-In documento" />
									</logic:equal>
								</logic:equal>
								<logic:equal name="documentoForm" property="statoDocumento"
									value="0">
									<html:submit styleClass="submit"
										...
										value="Classifica" alt="Classifica il documento" />
									<html:submit styleClass="submit"
										property="checkoutDocumentoAction" value="Check-Out"
										alt="Check-Out documento" />
								</logic:equal>
							...
							<logic:equal name="documentoForm" property="permessoCorrente"
								...
								<logic:equal name="documentoForm" property="statoDocumento"
									...
									<html:submit styleClass="submit"
										...
										alt="Check-Out documento" />
									<html:submit styleClass="submit"
										property="eliminaDocumentoAction" value="Elimina"
										alt="Elimina documento" />
								</logic:equal>
							</logic:equal>
								...
								<logic:equal name="documentoForm" property="statoDocumento"
									...
									<logic:equal name="documentoForm" property="owner" value="true">
										...
										<html:submit styleClass="submit"
											...
											value="Classifica" alt="Classifica il documento" />
										<html:submit styleClass="submit"
											property="spostaDocumentoAction" value="Sposta"
											alt="Sposta nella cartella..." />
										<html:submit styleClass="submit"
											property="checkinDocumentoAction" value="Check-In"
											alt="Check-In documento" />
									</logic:equal>
						...
						<logic:equal name="documentoForm" property="statoArchivio"
							...
							<logic:equal name="documentoForm" property="permessoCorrente"
								...
								<logic:empty name="documentoForm" property="fascicoliDocumento">
									<html:submit styleClass="submit"
										property="spostaDocumentoInLavorazioneAction"
										value="Sposta in lavorazione"
										alt="Imposta lo stato del documento per modifiche" />
								</logic:empty>
								<html:submit styleClass="submit"
									property="inviaProtocolloAction" value="Invia al protocollo"
									alt="Invia al protocollo" />
								<html:submit styleClass="submit"
									property="documentiArchivioAction" value="Protocolla"
									alt="Protocolla" />
								<html:submit styleClass="submit"
									property="visualizzaFascicolaDocumentoAction"
									value="Fascicola Documento" alt="Fascicola il Documento" />
							</logic:equal>
							<logic:equal name="documentoForm" property="permessoCorrente"
								value="4">
								<logic:empty name="documentoForm" property="fascicoliDocumento">
								...
								<html:submit styleClass="submit"
									property="inviaProtocolloAction" value="Invia al protocollo"
									alt="Invia al protocollo" />
								<html:submit styleClass="submit" property="protocolla"
						...
						<logic:greaterThan name="documentoForm" property="versione"
							...
							<logic:equal name="documentoForm" property="versioneDefault"
								value="true">
								<logic:greaterThan name="documentoForm"
									property="permessoCorrente" value="0">
									<html:submit styleClass="submit"
