...
<jsp:include page="/WEB-INF/subpages/documentale/common/path.jsp" />
<jsp:include page="/WEB-INF/subpages/documentale/common/cartelle.jsp" />
<jsp:include page="/WEB-INF/subpages/documentale/common/files.jsp" />
</html:form>
</eprot:page>
