...
/**
 * A multithreaded blocking queue which is very useful for implementing
 * producer-consumer style threading patterns.
 * <p>
 * Multiple blocking threads can wait for items being added to the queue while
 * other threads add to the queue.
 * <p>
