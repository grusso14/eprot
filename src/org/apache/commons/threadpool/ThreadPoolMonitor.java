...
/**
 * The idea is that the end-user can write a implementation of this class that
 * allows them have a deterministic for the events that are monitored for. I.e.
 * they can change the state of other parts of their system (or not).
 * 
